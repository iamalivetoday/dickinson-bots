...
def main():
    ...
    def speak(author, user_msg):
        ...
        with torch.no_grad():
            out = model.generate(**ins, max_new_tokens=args.max_new, do_sample=True,
                                 temperature=args.temp, top_p=0.9, repetition_penalty=1.2,
